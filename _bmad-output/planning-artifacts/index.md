---
title: "PetGo V1.0 规划产物索引（Planning Artifacts Index）"
project: petGo
created: 2026-06-01
...
| [`PetGo_V1_mockups.html`](./PetGo_V1_mockups.html) | 🖼️ 效果图 | 21 屏全屏效果图（S01–S21）| `PetGo_V1_全屏效果图.html` |
...
- ✅ PRD / UX / 效果图 / 技术框架已对齐到 **PetGo V1**（导航 5-Tab、AI 仅图文、兽医聊天支持视频、攒局移 V2）
