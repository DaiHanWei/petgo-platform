...
| **batch-b1** · 场所发现与社交基建包 | `feat/1.3.0-batch-b1-places-social` | 待拆 | 未拆 | PRD / UI 稿 / 代码核对报告 / 决策日志 / 架构 delta 均已入库；13 条决策已定，AB-17A 已确认在做 —— **阻塞项清零，可拆 epics** |
...
| batch-b1 | `PRD-v1.3.0-batch-b1-places-social.md` | `architecture-v1.3.0-batch-b1-delta.md` | 待建 | `决策日志-batch-b1.md` | 待建 |
