...
| **shop-v2** · 电商板块 V2（体验 / 运营后台 / 履约 / 客服可达） | `feat/1.3.0-shop-v2` | 待定 | — | PRD 两轮校验后定稿待架构（2026-09-15，SD-1~18）；第二批运营提效组依赖 admin Epic 10 |
...
| shop-v2 | `PRD-v1.3.0-shop-v2.md`（附录 `PRD-v1.3.0-shop-v2-addendum.md`） | — | — | `决策日志-shop-v2.md` | — |
