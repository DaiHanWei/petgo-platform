...
> 状态：**实现中**（2026-09-10）。两个主题的规划产物均已入库，story 全部 ready-for-dev。
...
| **shop-v2** · 电商板块 V2（体验 / 运营后台 / 履约 / 客服可达） | `feat/1.3.0-shop-v2` | 待定 | — | PRD 两轮校验后定稿（SD-1~18）；架构 delta 已出（2026-09-16，AD-S1~S13），待评审后拆 epics；第二批运营提效组依赖 admin Epic 10 |
...
| shop-v2 | `PRD-v1.3.0-shop-v2.md`（附录 `PRD-v1.3.0-shop-v2-addendum.md`） | `architecture-v1.3.0-shop-v2-delta.md` | — | `决策日志-shop-v2.md` | — |
