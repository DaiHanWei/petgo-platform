...
版本基线（2026-06 联网核实）：Flutter 3.44.x / Dart 3.12 · Spring Boot 4.0.x · Java 25 LTS（替代框架原拟的 SB3/Java21——Java 21 的 LTS 支持窗口 2026-09 收窄，新项目取 25 LTS 更省一次大版本迁移）。
...
- 语言/运行时：Java 25 LTS，Spring Boot 4.0.x，打包 jar，部署德国单机。
...
- **技术兼容**：SB4.0.x + Java25 + springdoc(SB4 兼容) + JPA/PostgreSQL/Flyway + Redis + Riverpod/go_router/dio + Gemini 2.5-flash + 腾讯 IM + 阿里 OSS——版本与组合均验证可用；不用 HATEOAS 规避了 springdoc/Jackson3 已知坑。
