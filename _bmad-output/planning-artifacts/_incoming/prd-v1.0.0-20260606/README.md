...
|---|---|---|
| PRD | `../../v1.0.0/PRD.md`（V1.0, 2026-06-01，驱动 46 story） | `V1-0-0PRD20260606.md`（V1.0.0, 2026-06-06） |
| UX 设计 | `../../v1.0.0/UX_DESIGN.md` | `UX_DESIGN.new.md` |
| UX 体验 | `../../v1.0.0/UX_EXPERIENCE.md` | `UX_EXPERIENCE.new.md` |
| 决策日志 | — | `decision-log.md`（旧版 5/29 决策，随源目录带入） |

**在 `bmad-correct-course` 产出变更提案并人工确认之前，46 story / 架构 / sprint 一律继续以 `../../v1.0.0/PRD.md` 为准。**
...
1. 生成《逐节变更影响报告》（基于本目录 PRD vs `../../v1.0.0/PRD.md`）
