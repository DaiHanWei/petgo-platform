...
/////////////////////////////////////////////////////////////////////////////////
  ...
  Future<TencentCloudChatPushResult> registerPush({
    ...
    if (imSdkAppID == null && sdkAppId == null) {
      TencentImSDKPlugin.v2TIMManager.uikitTrace(
        trace: "$tag Please initialize Tencent Cloud Chat SDK before register push plugin.",
      );
    }

    if ((userID == null || userSig == null) && appKey == null) {
      TencentImSDKPlugin.v2TIMManager.uikitTrace(
        trace: "$tag Please log in to Tencent Cloud Chat SDK before register push plugin.",
      );
    }
    ...
    if (sdkAppId == null && imSdkAppID != null) {
      sdkAppId = imSdkAppID;
    }
