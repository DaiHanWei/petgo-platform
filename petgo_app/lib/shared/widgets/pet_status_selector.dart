...
/// 宠物状态三选一（HAS_PET/PLANNING/ENTHUSIAST）可复用组件（FR-0F / FR-21 / FR-20）。
///
...
class PetStatusSelector extends StatelessWidget {
  ...
  /// 当前选中（'HAS_PET'|'PLANNING'|'ENTHUSIAST'，null=未选）。
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        _option('HAS_PET', l10n.petStatusA),
        const SizedBox(height: AppSpacing.md),
        _option('PLANNING', l10n.petStatusB),
        const SizedBox(height: AppSpacing.md),
        _option('ENTHUSIAST', l10n.petStatusC),
      ],
    );
  }
